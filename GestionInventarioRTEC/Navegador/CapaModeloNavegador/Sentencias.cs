    ...
    public class Sentencias
    {
        ...
        public void metodoLlenarCombo(ComboBox cbx, string tabla, string value, string display, string estatus)
        {
            try
            {
                ...
                String psql = "SELECT * FROM " + " " + tabla + " " + "WHERE " + " " + estatus + "= 'A' or " + estatus + "= '1' AND Fk_Empresa= '2';";
        ...
        {
            Conexion cn = new Conexion();
            string sql = "select * from " + tabla + " AND Fk_Empresa= '2' " + "ORDER BY" + " " + "length(" + arreglo[0].Tag.ToString() + ")ASC";
